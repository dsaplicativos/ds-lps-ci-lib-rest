 ...
 * que usava o carregamento de arquivo de configuração a partir do
 * diretório application/config
 * 
...
class RestConfig {
	...
	/**
	 * Define os valores de configuração necessários ao funcionamento
	 * do plugin Rest.
	 * 
	...
	private function run($ci) {
		...
		/**
		 ...
		 |           $ci->config->set_item('auth_override_class_method']['accounts']['user', 'basic';
		 |           $ci->config->set_item('auth_override_class_method']['dashboard']['*', 'none|digest|basic';
		 |
		 | Here 'deals', 'accounts' and 'dashboard' are controller names, 'view', 'insert' and 'user' are methods within. An asterisk may also be used to specify an authentication method for an entire classes methods. Ex: $ci->config->set_item('auth_override_class_method']['dashboard']['*', 'basic'; (NOTE: leave off the '_get' or '_post' from the end of the method name)
		...
		// $ci->config->set_item('auth_override_class_method']['deals']['insert', 'digest';
		// $ci->config->set_item('auth_override_class_method']['accounts']['user', 'basic';
		// $ci->config->set_item('auth_override_class_method']['dashboard']['*', 'basic';
		
		
		// ---Uncomment list line for the wildard unit test
		// $ci->config->set_item('auth_override_class_method']['wildcard_test_cases']['*', 'basic';
		...
		// ---Uncomment list line for the wildard unit test
		// $ci->config->set_item('auth_override_class_method_http']['wildcard_test_cases']['*']['options', 'basic';
